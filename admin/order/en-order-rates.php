...
/**
 * Order page rates.
 * Class EnUvsOrderRates
 * @package EnUvsOrderRates
 */
if (!class_exists('EnUvsOrderRates')) {

    class EnUvsOrderRates {

        /**
         * Hook in ajax handlers.
         * EnUvsOrderRates constructor.
         */
        public function __construct() {
            add_action('wp_ajax_nopriv_en_uvs_admin_order_quotes', array($this, 'en_uvs_admin_order_quotes'));
            add_action('wp_ajax_en_uvs_admin_order_quotes', array($this, 'en_uvs_admin_order_quotes'));
        }

        /**
         * Get quotes from calculate shipping forcefully
         */
        public function en_uvs_admin_order_quotes() {
            global $woocommerce;
            $errors = array();
            ...
            $shipping_class = new \EnUvsShippingRates();
