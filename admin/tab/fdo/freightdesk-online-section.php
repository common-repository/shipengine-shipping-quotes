<?php
/**
 * Shipengine Freightdesk online Template
 *
 * @package     ShipEngine Quotes
...
if (get_option('en_fdo_company_id_status') != 1) {
    $button_connect = '<a href="javascript:void(0)" id="fd_online_id_uvs_s" class="button-primary">Connect</a>';
    ...
    if(get_option('en_fdo_company_id_status') == 1) {
        $button_connect = '<a href="javascript:void(0)" data="disconnect" id="fd_online_id_uvs_s" class="button-primary">Disconnect</a>';
