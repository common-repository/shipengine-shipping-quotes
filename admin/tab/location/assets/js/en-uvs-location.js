jQuery(document).ready(function () {
    ...
    jQuery('#en_uvs_location_zip').on('change', function (e) {
        let en_post_data = {
            'action': 'en_uvs_get_location',
            'en_uvs_location_zip': jQuery('#en_uvs_location_zip').val()
        };

        let en_params = {
            en_ajax_loading_id: '#en_uvs_location_zip,#en_location_city,#en_location_state,#en_location_country',
        };

        en_ajax_request(en_params, en_post_data, en_uvs_get_location);
    });
    ...
    jQuery('.en_uvs_location_btn').on('click', function (e) {
        ...
        var tab = get_parameter_by_uvs('tab');

        let en_post_data = {
            'tab': tab,
            'action': 'en_uvs_location_save_form_data',
            'en_post_data': jQuery(".en_popup_location_form input").serialize()
        };

        let en_params = {
            en_ajax_loading_msg_btn: '.en_uvs_location_btn',
        };

        en_ajax_request(en_params, en_post_data, en_uvs_location_save_form_data);
 ...
 */
if (typeof en_uvs_location_save_form_data != 'function') {
    function en_uvs_location_save_form_data(params, response) {
 ...
 */
if (typeof en_uvs_get_location != 'function') {
    function en_uvs_get_location(params, response) {
        let data = JSON.parse(response);
 ...
 */
if (typeof en_uvs_location_edit != 'function') {
    function en_uvs_location_edit(e, data, en_location_type) {
        e.preventDefault();
 ...
 * Get url detail
 */
if (typeof get_parameter_by_uvs != 'function') {
    function get_parameter_by_uvs(name) {
 ...
 */
if (typeof en_uvs_location_delete != 'function') {
    function en_uvs_location_delete(e, data, en_location_type, en_location_id) {
        e.preventDefault();
...
if (typeof en_location_confirm_delete != 'function') {
    function en_location_confirm_delete(data, en_location_type, en_location_id) {
        ...
        let en_post_data = {
            'tab': tab,
            'action': 'en_uvs_location_delete_row',
