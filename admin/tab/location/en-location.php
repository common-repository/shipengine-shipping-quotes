        ...
        static public function en_location_data()
        {
            ...
            $en_location_data = [
                ...
                'en_local_delivery_fee' => [
                    ...
                    'class' => 'en_location_input_field ' . esc_attr($disabled_plan),
                    'append' => ' data-optional="1" data-semi-optional="en_enable_local_delivery title" title="Local delivery fee" data-semi-type="checkbox" onchange="en_round_two_digits_after_decimal(this)" ',
                    'append_after' => '<span class="en_location_error"></span>',
                ],
...
//      We can use hook for add new location field from other plugin add-on
            return apply_filters('en_uvs_add_location', $en_location_data);
        }
        ...
        static public function en_arrange_location_table_row($en_location_list, $en_data, $location_bol, $disabled_plan = '')
        {
            ...
            foreach ($en_location_list as $key => $location) {
                ...
                echo '<a href="javascript(0)" onclick="return en_uvs_location_edit(event, this,' . $location_bol . ')"> <img src = "' . esc_url( EN_UVS_DIR_FILE ) . '/admin/tab/location/assets/images/edit.png" title = "Edit" ></a>';
                echo '<a href="javascript(0)" onclick="return en_uvs_location_delete(event, this,' . $location_bol . ' , ' . esc_attr($en_location_id) . ')"> <img  src = "' . esc_url( EN_UVS_DIR_FILE ) . '/admin/tab/location/assets/images/delete.png" title = "Delete" ></a>';
                echo '</td>';
        ...
        static public function en_load()
        {
            ...
            echo '<input type="submit" value="Save" class="en_uvs_location_btn button-primary">';
            echo '</form>';
            echo '</div>';
            echo '</div>';

            echo \EnUvs\EnUvsWarehouseTemplate::en_load();
            echo \EnUvs\EnUvsDropshipTemplate::en_load();
        }
